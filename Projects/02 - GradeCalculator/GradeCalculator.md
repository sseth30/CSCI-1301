# `GradeCalculator.java` Example Prompts

> [!IMPORTANT]
This document outlines several interactions with `GradeCalculator.java`, a course grade calculator program.
> This program details specific scenarios that simple grade calculators may not address, including but not limited to: having all or some scores, achieving or not achieving the desired grade, figuring out the minimum score to get a projected grade, percentage weights not adding up, and entering invalid grades or inputs.
