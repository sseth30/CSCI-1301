// For an overview of the program and sample inputs, be sure to check out `DrawingShapes.md`
...
public class DrawingShapes {
    ...
    // All handleShape methods makes sure that the length > 1 and height (if asked) is also > 1
