// Purpose: This program takes a grading scale and allows the user to input their calculated grades based on a mix of exams, labs, projects,
...
// If the user does not have all of the grades, the program will output a minimum grade and necessary average for the remaining grading items.
